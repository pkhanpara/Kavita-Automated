...
**Repository Renamed:** April 1, 2026

Kavita-Automated is a fast, feature rich, cross-platform AI-enhanced reading server. Built with a focus for being a full solution for all your reading needs. Set up your own server and share
your reading collection with your friends and family!

**New AI Capabilities:**
- **Study Assistant:** AI-powered learning tools for enhanced comprehension
- **Character Intelligence:** Automatic character identification and relationship mapping
- **Interactive Q&A:** Ask questions about any read pages and receive intelligent responses
- **Auto-Import:** Seamless book integration into Kavita library and directory
...
- Customizable theming support: [Theme Repo](https://github.com/Kareadita/Themes) and [Documentation](https://wiki.kavita-automated.com/guides/themes)
...
[https://demo.kavita-automated.com/](https://demo.kavita-automated.com/login?apiKey=9003cf99-9213-4206-a787-af2fe4cc5f1f)
```
Username: demouser
Password: Demouser64
```
...
[https://wiki.kavita-automated.com/getting-started](https://wiki.kavita-automated.com/getting-started)

## Feature Requests
Got a great idea? Throw it up on [Discussions](https://github.com/pkhanpara/Kavita-Automated/discussions) or vote on another idea. Many great features in Kavita-Automated are driven by our community.

**Recent Updates (April 2026):**
- Repository renamed to Kavita-Automated to reflect AI-powered enhancements
- Added auto-import functionality for seamless book library integration
- Implemented AI-driven study tools, character intelligence, and interactive Q&A features 
...
- **Original Repository:** [Kareadita/Kavita](https://github.com/Kareadita/Kavita)
- **Renamed:** April 1, 2026

### License
* [GNU GPL v3](http://www.gnu.org/licenses/gpl.html)
* Copyright 2020-2024

**Forked with AI Enhancements:** This repository has been forked from Kareadita/Kavita and enhanced with artificial intelligence capabilities including automated book import, intelligent character tracking, and interactive Q&A features for enhanced study and learning experiences.
